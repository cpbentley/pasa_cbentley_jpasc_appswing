 ...
 *
 */
public abstract class MenuBarPascalMainAbstract extends MenuBarPascalAbstract implements ActionListener, ICommandable {
   ...
   public MenuBarPascalMainAbstract(PascAppCtx pec, CBentleyFrame frame) {
