 ...
 *
 */
public class MenuBarPascalNoConnection extends MenuBarPascalAbstract implements ActionListener {
   ...
   public MenuBarPascalNoConnection(PascAppCtx pec, CBentleyFrame frame) {
